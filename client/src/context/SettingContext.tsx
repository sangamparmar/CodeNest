...
const defaultSettings: Settings = {
    theme: "Dracula", // Default editor theme
    language: "Javascript",
    fontSize: 16,
...
function SettingContextProvider({ children }: { children: ReactNode }) {
    ...
    // Allow the stored theme to be used for the editor
    const storedTheme =
    ...
    useEffect(() => {
        ...
        const updatedSettings = {
            theme, // Save the chosen editor theme
            language,
            fontSize,
            fontFamily,
            showGitHubCorner,
    ...
    return (
        <SettingContext.Provider
            value={{
                // Allow theme to be changed for the editor
                theme,
                setTheme,
                language,
                setLanguage,
