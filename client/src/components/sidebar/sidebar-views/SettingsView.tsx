        ...
        >
            ...
            <div className="flex w-full items-end gap-2">
                <Select
                    ...
                    title="Font Family"
                />
                {/* Choose font size option */}                <select
                    value={fontSize}
                    onChange={handleFontSizeChange}
                    className="rounded-md border-none bg-darkHover px-4 py-2 text-white outline-none sidebar-select"
                    title="Font Size"
                >
            ...
            <Select
                ...
                title="Language"
            />
            {/* Show GitHub corner option */}            <div className="mt-4 flex w-full items-center justify-between">
                <label className="sidebar-label">Show github corner</label>
                ...
                className="mt-auto w-full rounded-md border-none bg-darkHover px-4 py-2 text-white outline-none sidebar-input"
